...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            <h2 class="font-weight-bold mb-1" style="font-size:1.5rem">SKU Terkategori</h2>
            <p class="text-muted mb-0" style="font-size:.875rem">SKU yang master barang-nya sudah ditentukan (bukan "Belum Dikategorikan")</p>
        </div>
...
var skuTable = $('#skuTable').DataTable({
    ...
    ajax: {
        ...
        data   : function(d) { d.terkategori_only = 1; },
    },
    columns: [
